...
public class GifService {
    ...
    static final String GIPHY_API_KEY = "giphy.api_key";
    static final String GIPHY_RANDOM_URL_KEY = "giphy.random.url";
    ...
    private HttpRequest buildRequestByTag(String tag) {
        URI uri = URI.create(String.format("%s?api_key=%s&tag=%s",
                PropertiesUtil.get(GIPHY_RANDOM_URL_KEY),
                PropertiesUtil.get(GIPHY_API_KEY),
                tag)
        );
